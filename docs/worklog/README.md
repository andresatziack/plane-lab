...
| Arquivo | O que é |
|---|---|
| `.kiro/steering/worklog-contexto.md` | **Contexto mestre.** 11 regras invioláveis, as 4 grandezas de tempo, arquitetura de Cliente, restrições técnicas reais do repositório. Carregado automaticamente |
