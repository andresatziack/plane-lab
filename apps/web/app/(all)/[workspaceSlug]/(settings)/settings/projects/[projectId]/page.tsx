...
import { ProjectServiceClientSection } from "@/components/project/settings/service-client-section";
  ...
  return (
    <SettingsContentWrapper header={<GeneralProjectSettingsHeader />}>
      ...
      <div className={`w-full ${isAdmin ? "" : "opacity-60"}`}>
        ...
        <ProjectServiceClientSection workspaceSlug={workspaceSlug} projectId={projectId} isAdmin={isAdmin} />
